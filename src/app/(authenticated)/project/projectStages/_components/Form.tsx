...
import { ProjectStageFormSchema } from "./schema";
import { transformToPrismaInput } from "./transformToPrismaInput";
import { zodResolver } from "@hookform/resolvers/zod";
export default function ProjectStageForm ({
 formMode = "create",
  defaultValues = {},
  invalidateQueryKey = ["data","https://api.techbee.et/api/project/projectStages"]
}: {
  ...
  const methods = useForm({
    defaultValues,
     resolver: zodResolver(ProjectStageFormSchema)
  });
  const { mutate, isPending } = useDataMutation({
    ...
    apiEndPoint:
      formMode === "create"
        ...
        : "https://api.techbee.et/api/project/projectStages/" + defaultValues?.id,
