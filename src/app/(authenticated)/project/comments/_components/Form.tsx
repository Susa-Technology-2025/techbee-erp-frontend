...
import { CommentCreateInputFormSchema } from "./schema";
import { transformToPrismaInput } from "./transformToPrismaInput";
import { zodResolver } from "@hookform/resolvers/zod";
export default function CommentCreateInputForm ({
 formMode = "create",
  defaultValues = {},
  invalidateQueryKey = ["data","https://api.techbee.et/api/project/comments"]
}: {
  ...
  const methods = useForm({
    defaultValues,
     resolver: zodResolver(CommentCreateInputFormSchema)
  });
  const { mutate, isPending } = useDataMutation({
    invalidateQueryKey,
    apiEndPoint:
      formMode === "create"
        ? "https://api.techbee.et/api/project/comments"
        : "https://api.techbee.et/api/project/comments/" + defaultValues?.id,
