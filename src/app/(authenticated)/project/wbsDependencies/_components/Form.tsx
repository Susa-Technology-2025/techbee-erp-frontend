...
import { WbsDependencyFormSchema } from "./schema";
import { transformToPrismaInput } from "./transformToPrismaInput";
import { zodResolver } from "@hookform/resolvers/zod";
export default function WbsDependencyForm ({
 formMode = "create",
  defaultValues = {},
  invalidateQueryKey = ["data","https://api.techbee.et/api/project/wbsDependencies"]
}: {
  ...
  const methods = useForm({
    defaultValues,
     resolver: zodResolver(WbsDependencyFormSchema)
  });
  const { mutate, isPending } = useDataMutation({
    invalidateQueryKey,
    apiEndPoint:
      formMode === "create"
        ? "https://api.techbee.et/api/project/wbsDependencies"
        : "https://api.techbee.et/api/project/wbsDependencies/" + defaultValues?.id,
