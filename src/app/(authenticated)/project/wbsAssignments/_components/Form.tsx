...
import { WbsAssignmentFormSchema } from "./schema";
import { transformToPrismaInput } from "./transformToPrismaInput";
import { zodResolver } from "@hookform/resolvers/zod";
export default function WbsAssignmentForm({
  formMode = "create",
  defaultValues = {},
  invalidateQueryKey = [
    "data",
    "https://api.techbee.et/api/project/wbsAssignments",
  ],
}: {
  ...
  const methods = useForm({
    defaultValues,
    resolver: zodResolver(WbsAssignmentFormSchema),
  });
  const {
    data: user,
    isLoading,
    ...
    apiEndPoint:
      "https://api.techbee.et/api/auth/users/" + defaultValues.employeeId,
    enabled: Boolean(defaultValues.employeeId),
    noFilter: true,
  });
  useEffect(() => {
  ...
  }, [defaultValues.employeeId, refetch]);
