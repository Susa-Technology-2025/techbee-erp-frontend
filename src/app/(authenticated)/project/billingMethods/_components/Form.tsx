...
import { BillingMethodSchema } from "./schema";
import { transformToPrismaInput } from "./transformToPrismaInput";
import { zodResolver } from "@hookform/resolvers/zod";
export default function BillingMethod ({
 formMode = "create",
  defaultValues = {},
  invalidateQueryKey = ["data","https://api.techbee.et/api/project/billingMethods"]
}: {
  ...
  const { mutate, isPending } = useDataMutation({
    ...
    apiEndPoint:
      formMode === "create"
        ? "https://api.techbee.et/api/project/billingMethods"
        : "https://api.techbee.et/api/project/billingMethods/" + defaultValues?.id,
