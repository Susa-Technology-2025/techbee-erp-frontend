...
export const FileNameField = ({index}: any) => {
    ...
    <Controller
      ...
      render={({ field: controllerField, fieldState }) => (
        <TextField
          ...
          helperText={fieldState.error ? "File Name is required" : "The name of the uploaded file."}
    ...
    <Controller
      ...
      render={({ field: controllerField, fieldState }) => (
        <TextField
          ...
          helperText={fieldState.error ? "This field is required" : "A detailed description for the attachment."}
          error={!!fieldState.error}
          disabled={false}
          className=""
          style={undefined}
...
export const MimeTypeField = ({index}: any) => {
  const { control: formControl } = useFormContext();
  return (
    <Controller
      name={`mimeType`}
      ...
      render={({ field: controllerField, fieldState }) => (
        <TextField
          ...
          helperText={fieldState.error ? "This field is required" : "The MIME type of the file (e.g., application/pdf)."}
          error={!!fieldState.error}
          disabled={false}
          className=""
           slotProps={{
...
export const SizeBytesField = ({index}: any) => {
  const { control: formControl } = useFormContext();
  return (
    <Controller
      name={`sizeBytes`}
      ...
      render={({ field: controllerField, fieldState }) => (
        <TextField
          ...
          helperText={fieldState.error ? "This field is required" : "The size of the file in bytes."}
          error={!!fieldState.error}
          disabled={false}
          className=""
           slotProps={{
...
export const VersionField = ({index}: any) => {
  const { control: formControl } = useFormContext();
  return (
    <Controller
      name={`version`}
      ...
      render={({ field: controllerField, fieldState }) => (
        <TextField
          ...
          helperText={fieldState.error ? "This field is required" : "The version number of the attachment."}
          error={!!fieldState.error}
          disabled={false}
          className=""
           slotProps={{
            ...
            <Autocomplete
              ...
              renderInput={(params) => (
                <TextField
                  ...
                  variant="standard"
                  label="Uploaded By Employee"
                  placeholder="Enter employee "
                  helperText={fieldState.error ? "This field is required" : "The employee who uploaded the attachment."}
                  error={!!fieldState.error}
                  className=""
                  style={undefined}
                  sx={{"width":"100%","mb":2}}
...
export const MilestoneField = ({ index }: any) => {
  ...
  slotProps={{
    ...
    inputLabel: {shrink: true}
                  ...
                  helperText={fieldState.error ? "This field is required" : "The milestone this attachment belongs to."}
                  error={!!fieldState.error}
                  className=""
                  style={undefined}
                  sx={{"width":"100%","mb":2}}
...
export const WbsItemField = ({ index }: any) => {
  ...
  slotProps={{
    ...
    inputLabel: {shrink: true}
                  ...
                  helperText={fieldState.error ? "This field is required" : "The WBS item this attachment belongs to."}
                  error={!!fieldState.error}
                  className=""
                  style={undefined}
                  sx={{"width":"100%","mb":2}}
