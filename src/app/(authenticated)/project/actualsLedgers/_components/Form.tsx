...
import { ActualsLedgerFormSchema } from "./schema";
import { transformToPrismaInput } from "./transformToPrismaInput";
import { zodResolver } from "@hookform/resolvers/zod";
export default function ActualsLedgerForm ({
 formMode = "create",
  defaultValues = {},
  invalidateQueryKey = ["data","https://api.techbee.et/api/project/actualsLedgers"]
}: {
  ...
  const methods = useForm({
    defaultValues,
     resolver: zodResolver(ActualsLedgerFormSchema)
  });
  const { mutate, isPending } = useDataMutation({
    invalidateQueryKey,
    apiEndPoint:
      formMode === "create"
        ? "https://api.techbee.et/api/project/actualsLedgers"
        : "https://api.techbee.et/api/project/actualsLedgers/" + defaultValues?.id,
