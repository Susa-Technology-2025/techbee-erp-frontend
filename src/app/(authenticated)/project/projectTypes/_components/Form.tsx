...
export default function ProjectTypeForm ({
 formMode = "create",
  ...
  const { mutate, isPending } = useDataMutation({
    ...
    apiEndPoint:
      formMode === "create"
        ? "https://api.techbee.et/api/project/projectTypes"
        : "https://api.techbee.et/api/project/projectTypes/" + defaultValues?.id,
          ...
          <Box sx={{ borderBottom: 1, borderColor: "divider" }}>
            ...
            >
              <Tab
                ...
                /> <Tab
                  label="NotificationLeads"
                  value="NotificationLeads"
                  sx={{
                    borderRadius: 1,
                    "&.Mui-selected": {
                      bgcolor: "action.selected",
