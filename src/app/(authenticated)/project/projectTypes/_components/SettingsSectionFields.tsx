...
export const DefaultWbsTemplateIdField = ({ index }: any) => {
  ...
  slotProps={{
    ...
    inputLabel: {shrink: true}
                  ...
                  helperText={fieldState.error ? "This field is required" : "The ID of the default WBS template for projects of this type."}
...
export const DefaultBillingMethodField = ({ index }: any) => {
  ...
  slotProps={{
    ...
    inputLabel: {shrink: true}
                  ...
                  helperText={fieldState.error ? "This field is required" : "The default billing method for projects of this type."}
                  error={!!fieldState.error}
                  className=""
                  style={undefined}
                  sx={{"width":"100%","mb":2}}
...
export const DefaultProjectStageSetField = ({ index }: any) => {
  ...
  slotProps={{
    ...
    inputLabel: {shrink: true}
                  ...
                  helperText={fieldState.error ? "This field is required" : "The default project stage set for projects of this type."}
                  error={!!fieldState.error}
                  className=""
                  style={undefined}
                  sx={{"width":"100%","mb":2}}
...
export const DefaultTaskStageSetField = ({ index }: any) => {
  ...
  slotProps={{
    ...
    inputLabel: {shrink: true}
                  ...
                  helperText={fieldState.error ? "This field is required" : "The default task stage set for tasks within projects of this type."}
                  error={!!fieldState.error}
                  className=""
                  style={undefined}
                  sx={{"width":"100%","mb":2}}
