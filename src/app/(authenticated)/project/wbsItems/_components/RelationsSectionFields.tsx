...
import  ParentFieldForm  from "../../wbsItems/_components/Form";
import  TaskStageFieldForm  from "../../taskStages/_components/Form";
            ...
            <Autocomplete
              ...
              renderInput={(params) => (
                <TextField
                  ...
                  helperText={fieldState.error ? "Milestone is required" : "The milestone associated with this WBS item."}
            ...
            <Autocomplete
              ...
              renderInput={(params) => (
                <TextField
                  ...
                  helperText={fieldState.error ? "Project is required" : "The project this WBS item belongs to."}
                  error={!!fieldState.error}
                  className=""
                  style={undefined}
                  sx={{"width":"100%","mb":2}}
...
export const ParentField = ({ index }: any) => {
  const { control: formControl } = useFormContext();
            ...
            <Autocomplete
              ...
              renderInput={(params) => (
                <TextField
                  ...
                  variant="standard"
                  label="Parent"
                  placeholder="Select a parent WBS item"
                  helperText={fieldState.error ? "Parent is required" : "The parent WBS item, if any."}
                  error={!!fieldState.error}
                  className=""
                  style={undefined}
                  sx={{"width":"100%","mb":2}}
...
export const TaskStageField = ({ index }: any) => {
  const { control: formControl } = useFormContext();
  
  const [options, setOptions] = useState([]);
  const endpoint = "https://api.techbee.et/api/project/taskStages"
            ...
            <Autocomplete
              ...
              renderInput={(params) => (
                <TextField
                  ...
                  variant="standard"
                  label="Task Stage"
                  placeholder="Select a task stage"
                  helperText={fieldState.error ? "Task stage is required" : "The current task stage of the WBS item."}
                  error={!!fieldState.error}
                  className=""
                  style={undefined}
                  sx={{"width":"100%","mb":2}}
