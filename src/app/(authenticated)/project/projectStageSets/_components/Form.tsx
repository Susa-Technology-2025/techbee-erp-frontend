...
import { ProjectStageSetFormSchema } from "./schema";
import { transformToPrismaInput } from "./transformToPrismaInput";
import { zodResolver } from "@hookform/resolvers/zod";
export default function ProjectStageSetForm ({
 formMode = "create",
  defaultValues = {},
  invalidateQueryKey = ["data","https://api.techbee.et/api/project/projectStageSets"]
}: {
  ...
  const methods = useForm({
    defaultValues,
     resolver: zodResolver(ProjectStageSetFormSchema)
  });
  const { mutate, isPending } = useDataMutation({
    ...
    apiEndPoint:
      formMode === "create"
        ...
        : "https://api.techbee.et/api/project/projectStageSets/" + defaultValues?.id,
