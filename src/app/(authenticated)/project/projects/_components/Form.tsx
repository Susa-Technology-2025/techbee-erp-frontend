...
import { ProjectCreateInputFormSchema } from "./schema";
import { transformToPrismaInput } from "./transformToPrismaInput";
import { zodResolver } from "@hookform/resolvers/zod";
export default function ProjectCreateInputForm ({
 formMode = "create",
  defaultValues = {},
  invalidateQueryKey = ["data","https://api.techbee.et/api/project/projects"]
}: {
  ...
  const methods = useForm({
    defaultValues,
     resolver: zodResolver(ProjectCreateInputFormSchema)
  });
  const { mutate, isPending } = useDataMutation({
    invalidateQueryKey,
    apiEndPoint:
      formMode === "create"
        ? "https://api.techbee.et/api/project/projects"
        : "https://api.techbee.et/api/project/projects/" + defaultValues?.id,
