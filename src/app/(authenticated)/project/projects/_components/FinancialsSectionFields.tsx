            ...
            <Autocomplete
              ...
              renderInput={(params) => (
                <TextField
                  ...
                  helperText={fieldState.error ? "Currency is required" : "The primary currency for the project's financials."}
    ...
    <Controller
      ...
      render={({ field: controllerField, fieldState }) => (
        <TextField
          ...
          helperText={fieldState.error ? "Actual cost is required" : "The actual cost incurred for the project."}
          error={!!fieldState.error}
          disabled={false}
          className=""
           slotProps={{
...
export const TotalBudgetField = ({index}: any) => {
  const { control: formControl } = useFormContext();
  return (
    <Controller
      name={`totalBudget`}
      ...
      render={({ field: controllerField, fieldState }) => (
        <TextField
          ...
          helperText={fieldState.error ? "Total budget is required" : "The total allocated budget for the project."}
          error={!!fieldState.error}
          disabled={false}
          className=""
           slotProps={{
...
export const VarianceField = ({index}: any) => {
  const { control: formControl } = useFormContext();
  return (
    <Controller
      name={`variance`}
      ...
      render={({ field: controllerField, fieldState }) => (
        <TextField
          ...
          helperText={fieldState.error ? "Variance is required" : "The variance between planned and actual costs/timelines."}
          error={!!fieldState.error}
          disabled={false}
          className=""
           slotProps={{
...
export const BillingMethodField = ({ index }: any) => {
  ...
  slotProps={{
    ...
    inputLabel: {shrink: true}
                  ...
                  helperText={fieldState.error ? "Billing method is required" : "The method used for billing the project."}
                  error={!!fieldState.error}
                  className=""
                  style={undefined}
                  sx={{"width":"100%","mb":2}}
