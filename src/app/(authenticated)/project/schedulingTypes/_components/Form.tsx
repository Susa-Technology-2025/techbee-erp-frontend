...
import { SchedulingTypeFormSchema } from "./schema";
import { transformToPrismaInput } from "./transformToPrismaInput";
import { zodResolver } from "@hookform/resolvers/zod";
export default function SchedulingTypeForm ({
 formMode = "create",
  defaultValues = {},
  invalidateQueryKey = ["data","https://api.techbee.et/api/project/schedulingTypes"]
}: {
  ...
  const methods = useForm({
    defaultValues,
     resolver: zodResolver(SchedulingTypeFormSchema)
  });
  const { mutate, isPending } = useDataMutation({
    invalidateQueryKey,
    apiEndPoint:
      formMode === "create"
        ? "https://api.techbee.et/api/project/schedulingTypes"
        : "https://api.techbee.et/api/project/schedulingTypes/" + defaultValues?.id,
