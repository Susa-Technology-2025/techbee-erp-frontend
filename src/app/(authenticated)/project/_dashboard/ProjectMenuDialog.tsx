...
interface ProjectMenuDialogProps {
    project: any;
    colors: {
        primary: string;
        success: string;
    ...
    ProjectCreateInputForm: React.ComponentType<{
                ...
                <DialogContent sx={{ pt: 3 }}>
                    ...
                    <Box sx={{
                        ...
                        <Typography variant="body2" sx={{ color: colors.gray }}>
                            Customer: {project?.customerName || 'N/A'} | Budget: {formatCurrency(project?.totalBudget)}
                        </Typography>
                    </Box>
