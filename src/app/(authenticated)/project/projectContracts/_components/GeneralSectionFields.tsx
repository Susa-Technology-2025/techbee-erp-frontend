...
import  BillingMethodFieldForm  from "../../billingMethods/_components/Form";
    ...
    <Controller
      ...
      render={({ field: controllerField, fieldState }) => (
        <TextField
          ...
          helperText={fieldState.error ? "Notes should be a valid string." : "Any relevant notes for the contract."}
...
export const LinkedInvoiceRefField = ({index}: any) => {
  const { control: formControl } = useFormContext();
  return (
    <Controller
      name={`linkedInvoiceRef`}
      control={formControl}
      rules={{ required: false }}
      render={({ field: controllerField, fieldState }) => (
        <TextField
          ...
          type="text" 
          variant="standard"
          label="Linked Invoice Ref"
          placeholder="Enter linked invoice reference"
          helperText={fieldState.error ? "Linked invoice reference should be a valid string." : "Reference to the linked invoice, if applicable."}
          error={!!fieldState.error}
          disabled={false}
          className=""
           slotProps={{
            ...
            <Autocomplete
              ...
              renderInput={(params) => (
                <TextField
                  ...
                  helperText={fieldState.error ? "Please select a valid currency." : "The currency used for the contract."}
                  error={!!fieldState.error}
                  className=""
                  style={undefined}
                  sx={{"width":"100%","mb":2}}
...
export const DefaultRateField = ({index}: any) => {
  const { control: formControl } = useFormContext();
  return (
    <Controller
      name={`defaultRate`}
      ...
      render={({ field: controllerField, fieldState }) => (
        <TextField
          ...
          helperText={fieldState.error ? "Default rate should be a valid number." : "The default rate for the contract."}
          error={!!fieldState.error}
          disabled={false}
          className=""
           slotProps={{
...
export const BillingMethodField = ({ index }: any) => {
  const { control: formControl } = useFormContext();
        ...
        render={({ field: controllerField, fieldState }) => {
          ...
          return (
            <Autocomplete
              ...
              options={options}
              sx={{ minWidth: 240, maxWidth: 360 }}
              getOptionLabel={option=>option.method||option.id}
  ...
  slotProps={{
    ...
    inputLabel: {shrink: true}
                  ...
                  helperText={fieldState.error ? "Billing method is required." : "The billing method associated with this contract."}
                  error={!!fieldState.error}
                  className=""
                  style={undefined}
                  sx={{"width":"100%","mb":2}}
    ...
    return (
      ...
      >
        <Checkbox
          ...
          sx={{ m: 0, p: 0 }}
        />
        {(option=>option.method||option.id)(option)}
      </ListItem>
    );
  }}
      ...
      >
        ...
        <DialogContent sx={{ p: 0, m: 0 }}>
           <BillingMethodFieldForm formMode="create" />
        </DialogContent>
      </Dialog>
    </>
  );
...
export const ProjectField = ({ index }: any) => {
  ...
  slotProps={{
    ...
    inputLabel: {shrink: true}
                  ...
                  helperText={fieldState.error ? "Project is required." : "The project associated with this contract."}
                  error={!!fieldState.error}
                  className=""
                  style={undefined}
                  sx={{"width":"100%","mb":2}}
    ...
    return (
      ...
      >
        <Checkbox
          ...
          sx={{ m: 0, p: 0 }}
        />
        {(option=>option.title||option.id)(option)}
      </ListItem>
    );
  }}
