...
import { TaskStageFormSchema } from "./schema";
import { transformToPrismaInput } from "./transformToPrismaInput";
import { zodResolver } from "@hookform/resolvers/zod";
export default function TaskStageForm ({
 formMode = "create",
  defaultValues = {},
  invalidateQueryKey = ["data","https://api.techbee.et/api/project/taskStages"]
}: {
  ...
  const methods = useForm({
    defaultValues,
     resolver: zodResolver(TaskStageFormSchema)
  });
  const { mutate, isPending } = useDataMutation({
    ...
    apiEndPoint:
      formMode === "create"
        ...
        : "https://api.techbee.et/api/project/taskStages/" + defaultValues?.id,
