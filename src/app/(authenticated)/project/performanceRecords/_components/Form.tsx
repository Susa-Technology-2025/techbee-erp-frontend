...
import {CostMetricsSection} from "./CostMetricsSection"
import {TimeMetricsSection} from "./TimeMetricsSection"
...
import { PerformanceRecordFormSchema } from "./schema";
import { transformToPrismaInput } from "./transformToPrismaInput";
import { zodResolver } from "@hookform/resolvers/zod";
export default function PerformanceRecordForm ({
 formMode = "create",
  defaultValues = {},
  invalidateQueryKey = ["data","https://api.techbee.et/api/project/performanceRecords"]
}: {
  ...
  const { mutate, isPending } = useDataMutation({
    ...
    apiEndPoint:
      formMode === "create"
        ? "https://api.techbee.et/api/project/performanceRecords"
        : "https://api.techbee.et/api/project/performanceRecords/" + defaultValues?.id,
