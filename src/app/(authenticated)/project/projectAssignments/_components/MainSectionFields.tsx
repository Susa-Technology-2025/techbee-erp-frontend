...
export const ProjectField = ({ index }: any) => {
  ...
  slotProps={{
    ...
    inputLabel: {shrink: true}
                  ...
                  helperText={fieldState.error ? "Project is required" : "The project associated with this assignment."}
...
export const IsOwnerField = ({index}: any) => {
  const { control: formControl } = useFormContext();
  return (
    <Controller
      name={`isOwner`}
      ...
      render={({ field: controllerField, fieldState }) => (
        <FormControl component="fieldset" className="">
          ...
          <FormHelperText error={!!fieldState.error}>
            {fieldState.error ? "Owner status is required" : "Indicates if the assigned member is the project owner."}
          </FormHelperText>
        </FormControl>
      )}
    />
            ...
            <Autocomplete
              ...
              renderInput={(params) => (
                <TextField
                  ...
                  helperText={fieldState.error ? "Employee is optional" : "The internal employee assigned to the project."}
                  error={!!fieldState.error}
                  className=""
                  style={undefined}
                  sx={{"width":"100%","mb":2}}
    ...
    <Controller
      ...
      render={({ field: controllerField, fieldState }) => (
        <TextField
          ...
          helperText={fieldState.error ? "External member name is optional" : "The name of the external member assigned to the project."}
          error={!!fieldState.error}
          disabled={false}
          className=""
           slotProps={{
            ...
            <Autocomplete
              ...
              renderInput={(params) => (
                <TextField
                  ...
                  helperText={fieldState.error ? "Role is optional" : "The role of the assigned member in the project."}
                  error={!!fieldState.error}
                  className=""
                  style={undefined}
                  sx={{"width":"100%","mb":2}}
    ...
    <Controller
      ...
      render={({ field: controllerField, fieldState }) => (
        <TextField
          ...
          helperText={fieldState.error ? "Allocation percent is optional" : "The percentage of time allocated to this project."}
          error={!!fieldState.error}
          disabled={false}
          className=""
           slotProps={{
    ...
    <Controller
      ...
      render={({ field: controllerField, fieldState }) => (
        <TextField
          ...
          helperText={fieldState.error ? "Start date is optional" : "The start date of the assignment."}
          error={!!fieldState.error}
          disabled={false}
          className=""
           slotProps={{
    ...
    <Controller
      ...
      render={({ field: controllerField, fieldState }) => (
        <TextField
          ...
          helperText={fieldState.error ? "End date is optional" : "The end date of the assignment."}
          error={!!fieldState.error}
          disabled={false}
          className=""
           slotProps={{
