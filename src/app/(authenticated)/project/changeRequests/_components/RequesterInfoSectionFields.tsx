...
export const RequestedByNameField = ({index}: any) => {
    ...
    <Controller
      ...
      render={({ field: controllerField, fieldState }) => (
        <TextField
          ...
          helperText={fieldState.error ? "This field is required" : "The name of the person who requested the change."}
            ...
            <Autocomplete
              ...
              renderInput={(params) => (
                <TextField
                  ...
                  placeholder="Enter the requester's employee"
                  helperText={fieldState.error ? "This field is required" : "The person who requested the change."}
                  error={!!fieldState.error}
                  className=""
                  style={undefined}
                  sx={{"width":"100%","mb":2}}
