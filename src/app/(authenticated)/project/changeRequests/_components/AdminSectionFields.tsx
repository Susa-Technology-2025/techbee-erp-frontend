...
export const ApprovalStatusField = ({ index }: any) => {
  const { control: formControl } = useFormContext();
  const options = ["Draft","Pending","Approved","Rejected"];
            ...
            <Autocomplete
              ...
              renderInput={(params) => (
                <TextField
                  ...
                  helperText={fieldState.error ? "Approval status is required" : "The current approval status of the change request."}
