...
export default function ChangeRequestCreateInputForm ({
 formMode = "create",
  defaultValues = {},
  invalidateQueryKey = ["data","https://api.techbee.et/api/project/changeRequests"]
}: {
  ...
  const methods = useForm({
    defaultValues,
     resolver: zodResolver(ChangeRequestCreateInputFormSchema)
  });
  const { mutate, isPending } = useDataMutation({
    invalidateQueryKey,
    apiEndPoint:
      formMode === "create"
        ? "https://api.techbee.et/api/project/changeRequests"
        : "https://api.techbee.et/api/project/changeRequests/" + defaultValues?.id,
