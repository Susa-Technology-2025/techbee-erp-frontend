...
import  EntriesFieldForm  from "../../timeEntries/_components/Form";
            ...
            <Autocomplete
              ...
              renderInput={(params) => (
                <TextField
                  ...
                  helperText={fieldState.error ? "Employee  is required" : "Fullname the employee submitting the timesheet."}
    ...
    <Controller
      ...
      render={({ field: controllerField, fieldState }) => (
        <TextField
          ...
          helperText={fieldState.error ? "Entry code is required" : "The unique entry code for the timesheet."}
          error={!!fieldState.error}
          disabled={false}
          className=""
           slotProps={{
    ...
    <Controller
      ...
      render={({ field: controllerField, fieldState }) => (
        <TextField
          ...
          helperText={fieldState.error ? "Total hours is invalid" : "The total number of hours recorded in the timesheet."}
          error={!!fieldState.error}
          disabled={false}
          className=""
           slotProps={{
    ...
    <Controller
      ...
      render={({ field: controllerField, fieldState }) => (
        <TextField
          ...
          helperText={fieldState.error ? "Total amount is invalid" : "The total amount associated with the timesheet."}
          error={!!fieldState.error}
          disabled={false}
          className=""
           slotProps={{
    ...
    <Controller
      ...
      render={({ field: controllerField, fieldState }) => (
        <TextField
          ...
          helperText={fieldState.error ? "Rejection reason is invalid" : "The reason provided for rejecting the timesheet."}
          error={!!fieldState.error}
          disabled={false}
          className=""
          style={undefined}
...
export const ApprovedByEmployeeIdField = ({index}: any) => {
  const { control: formControl } = useFormContext();
  return (
    <Controller
      ...
      render={({ field: controllerField, fieldState }) => (
        <TextField
          ...
          placeholder="Enter approved by employee ID"
          helperText={fieldState.error ? "Approved by employee ID is invalid" : "The ID of the employee who approved the timesheet."}
          error={!!fieldState.error}
          disabled={false}
          className=""
           slotProps={{
    ...
    <Controller
      ...
      render={({ field: controllerField, fieldState }) => (
        <TextField
          ...
          helperText={fieldState.error ? "Approved at is invalid" : "The date and time the timesheet was approved."}
          error={!!fieldState.error}
          disabled={false}
          className=""
           slotProps={{
    ...
    <Controller
      ...
      render={({ field: controllerField, fieldState }) => (
        <TextField
          ...
          helperText={fieldState.error ? "Submitted at is invalid" : "The date and time the timesheet was submitted."}
          error={!!fieldState.error}
          disabled={false}
          className=""
           slotProps={{
...
export const EntriesField = ({ index }: any) => {
  const { control: formControl } = useFormContext();
  
  const [options, setOptions] = useState([]);
  const endpoint = "https://api.techbee.et/api/project/timeEntries"
  ...
  slotProps={{
    ...
    inputLabel: {shrink: true}
                  ...
                  variant="standard"
                  label="Entries"
                  placeholder="Select time entries"
                  helperText={fieldState.error ? "Entries are invalid" : "The time entries associated with this timesheet."}
                  error={!!fieldState.error}
                  className=""
                  style={undefined}
                  sx={{"width":"100%","mb":2}}
    ...
    return (
      ...
      >
        ...
        <DialogContent sx={{ p: 0, m: 0 }}>
           <EntriesFieldForm formMode="create" />
        </DialogContent>
      </Dialog>
    </>
  );
