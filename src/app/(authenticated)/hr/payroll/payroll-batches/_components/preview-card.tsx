                    ...
                    >
                      <Box>
                        <Typography variant="h6" fontWeight={600}>
                          ...
                          {payslip.employee?.fatherName}
                        </Typography>
                        <Typography variant="body2" color="text.secondary">
                          ID: {payslip?.employee?.employeeCode || "N/A"} | TIN:{" "}
              ...
              <CardContent>
                ...
                >
                  ...
                  {summary && Object.entries(summary).map(([key, value]) => {
                    // Skip objects and only show primitive values
                    ...
                    const isCurrency = typeof value === 'number' &&
                      !key.toLowerCase().includes('totalpayslipsgenerated') &&
                  ...
                  {/* Rule totals - preserved exactly as before */}
                  {summary?.totalByRule &&
                    Object.values(summary.totalByRule).map(
                      (rule: any, index: number) => (
                        <Paper
