...
import { RoleCreateInputFormSchema } from "./schema";
import { transformToPrismaInput } from "./transformToPrismaInput";
import { zodResolver } from "@hookform/resolvers/zod";
export default function RoleCreateInputForm ({
 formMode = "create",
  defaultValues = {},
  invalidateQueryKey = ["data","https://api.techbee.et/api/auth/roles"]
}: {
  ...
  const methods = useForm({
    defaultValues,
     resolver: zodResolver(RoleCreateInputFormSchema)
  });
  const { mutate, isPending } = useDataMutation({
    invalidateQueryKey,
    apiEndPoint:
      formMode === "create"
        ? "https://api.techbee.et/api/auth/roles"
        : "https://api.techbee.et/api/auth/roles/" + defaultValues?.id,
