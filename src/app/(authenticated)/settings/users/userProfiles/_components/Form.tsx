...
export default function UserProfileForm ({
 formMode = "create",
  defaultValues = {},
  invalidateQueryKey = ["data","https://api.techbee.et/api/auth/userProfiles"]
}: {
  ...
  const { mutate, isPending } = useDataMutation({
    ...
    apiEndPoint:
      formMode === "create"
        ? "https://api.techbee.et/api/auth/userProfiles"
        : "https://api.techbee.et/api/auth/userProfiles/" + defaultValues?.id,
