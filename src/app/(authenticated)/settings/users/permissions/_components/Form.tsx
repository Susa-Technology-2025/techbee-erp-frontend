...
export default function PermissionForm ({
 formMode = "create",
  defaultValues = {},
  invalidateQueryKey = ["data","https://api.techbee.et/api/auth/permissions"]
}: {
  ...
  const { mutate, isPending } = useDataMutation({
    ...
    apiEndPoint:
      formMode === "create"
        ? "https://api.techbee.et/api/auth/permissions"
        : "https://api.techbee.et/api/auth/permissions/" + defaultValues?.id,
