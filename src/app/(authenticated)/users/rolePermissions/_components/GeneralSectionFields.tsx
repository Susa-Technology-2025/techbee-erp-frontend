...
export const PermissionCodeField = ({index}: any) => {
    ...
    <Controller
      ...
      render={({ field: controllerField, fieldState }) => (
        <TextField
          ...
          helperText={fieldState.error ? "This field is required" : "The unique code identifying the permission."}
            ...
            <Autocomplete
              ...
              renderInput={(params) => (
                <TextField
                  ...
                  helperText={fieldState.error ? "This field is required" : "The role associated with this permission."}
                  error={!!fieldState.error}
                  className=""
                  style={undefined}
                  sx={{"width":"100%","mb":2}}
